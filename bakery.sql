...
INSERT INTO `cache_tags` VALUES ('asset_1','asset_1'),('asset_2','asset_2'),('asset_3','asset_3'),('asset_4','asset_4'),('asset_5','asset_5'),('object_3','asset_5'),('asset_6','asset_6'),('asset_7','asset_7'),('object_7','asset_7'),('asset_8','asset_8'),('object_8','asset_8'),('asset_9','asset_9'),('object_9','asset_9'),('object_3','class_1'),('object_8','class_1'),('object_7','class_2'),('object_9','class_2'),('document_1','document_1'),('document_properties_1','document_1'),('document_properties_1','document_properties'),('object_1','object_1'),('object_3','object_3'),('object_properties_3','object_3'),('object_4','object_4'),('object_6','object_6'),('object_7','object_7'),('object_8','object_8'),('object_properties_8','object_8'),('object_9','object_9'),('object_properties_9','object_9'),('object_properties_3','object_properties'),('object_properties_8','object_properties'),('object_properties_9','object_properties'),('system_route_redirect','redirect'),('system_resource_columns_edit_lock','resource'),('system_route_redirect','route'),('site_domain_a33e7aa7e0f8c990c987d3d9c8e592f6','site'),('site_domain_a33e7aa7e0f8c990c987d3d9c8e592f6','system'),('system_resource_columns_edit_lock','system'),('system_route_redirect','system'),('system_supported_locales_en','system'),('translation_data_admin_en','translate'),('translation_data_admin_en','translator'),('translation_data_admin_en','translator_website');
...
INSERT INTO `classes` VALUES ('1','Category'),('2','Product');
...
INSERT INTO `dependencies` VALUES (1,'object',3,'asset',5),(4,'object',7,'asset',7),(5,'object',7,'object',3),(6,'object',8,'asset',8),(7,'object',9,'asset',9),(8,'object',9,'object',8);
...
INSERT INTO `documents` VALUES (1,0,'page','','/',999999,1,1617205499,1617205499,1,1,0);
...
INSERT INTO `edit_lock` VALUES (65,3,'object',2,'aku9ff1ojp085a50je6s2qhch3',1617273309),(66,8,'object',2,'aku9ff1ojp085a50je6s2qhch3',1617273310),(67,9,'object',2,'aku9ff1ojp085a50je6s2qhch3',1617273310);
...
/*!50001 CREATE VIEW `object_2` AS SELECT 
 ...
 1 AS `price__value`,
 1 AS `price__unit`,
 1 AS `categoryType__id`,
 1 AS `categoryType__type`,
 1 AS `manufacturedOn`,
 1 AS `expiry`,
 1 AS `o_id`,
 1 AS `o_parentId`,
...
CREATE TABLE `object_query_2` (
  ...
  `categoryType__id` int DEFAULT NULL,
  `categoryType__type` enum('document','asset','object') DEFAULT NULL,
...
INSERT INTO `object_relations_2` VALUES (6,7,3,'object','categoryType',0,'object','','0'),(7,9,8,'object','categoryType',0,'object','','0');
...
INSERT INTO `objects` VALUES (1,0,'folder','','/',999999,1,1617205500,1617205500,1,1,NULL,NULL,NULL,NULL,0),(3,4,'object','Cake','/Category/',0,1,1617255697,1617257802,2,2,'1','Category',NULL,NULL,7),(4,1,'folder','Category','/',NULL,1,1617257799,1617257798,2,2,NULL,NULL,NULL,NULL,2),(6,1,'folder','Product','/',NULL,1,1617262101,1617262100,2,2,NULL,NULL,NULL,NULL,2),(7,6,'object','Rainbow Cake','/Product/',0,1,1617262137,1617271189,2,2,'2','Product',NULL,NULL,23),(8,4,'object','Cookie','/Category/',0,1,1617271341,1617271530,2,2,'1','Category',NULL,NULL,2),(9,6,'object','RedVelvet Cookies','/Product/',0,1,1617271617,1617271964,2,2,'2','Product',NULL,NULL,2);
...
INSERT INTO `recyclebin` VALUES (1,'object','folder','/Product',1,1617261401,'admin'),(2,'object','object','/Rainbow Cake',1,1617262217,'admin');
...
INSERT INTO `search_backend_data` VALUES (2,'/_default_upload_bucket','asset','folder','folder',1,1617255410,1617255410,1,0,'ID: 2  \nPath: /_default_upload_bucket  \n_default_upload_bucket default upload bucket',''),(3,'/_default_upload_bucket/raibowcake.jpeg','asset','image','image',1,1617255411,1617255411,2,2,'ID: 3  \nPath: /_default_upload_bucket/raibowcake.jpeg  \nraibowcake.jpeg FileName raibowcake.jpeg FileDateTime 1617255411 FileSize 15362 FileType MimeType image/jpeg SectionsFound default upload bucket raibowcake jpeg',''),(3,'/Category/Cake','object','object','Category',1,1617255697,1617257802,2,2,'ID: 3  \nPath: /Category/Cake  \nCake Cake Cake form sweet food made from flour sugar and other ingredients that usually baked. their oldest forms cakes were modifications bread but cakes now cover wide range preparations that can simple elaborate and that share features with other desserts such pastries meringues custards and pies. 10% Category',''),(4,'/_default_upload_bucket/raibowcake_1.jpeg','asset','image','image',1,1617255650,1617255650,2,2,'ID: 4  \nPath: /_default_upload_bucket/raibowcake_1.jpeg  \nraibowcake_1.jpeg FileName raibowcake_1.jpeg FileDateTime 1617255650 FileSize 15362 FileType MimeType image/jpeg SectionsFound default upload bucket raibowcake jpeg',''),(4,'/Category','object','folder','folder',1,1617257799,1617257798,2,2,'ID: 4  \nPath: /Category  \nCategory Category',''),(5,'/_default_upload_bucket/cake category.jpg','asset','image','image',1,1617256052,1617256052,2,2,'ID: 5  \nPath: /_default_upload_bucket/cake category.jpg  \ncake category.jpg FileName cake category.jpg FileDateTime 1617256052 FileSize 92785 FileType MimeType image/jpeg SectionsFound default upload bucket cake category jpg',''),(6,'/_default_upload_bucket/raibowcake_2.jpeg','asset','image','image',1,1617257506,1617257506,2,2,'ID: 6  \nPath: /_default_upload_bucket/raibowcake_2.jpeg  \nraibowcake_2.jpeg FileName raibowcake_2.jpeg FileDateTime 1617257506 FileSize 15362 FileType MimeType image/jpeg SectionsFound default upload bucket raibowcake jpeg',''),(6,'/Product','object','folder','folder',1,1617262101,1617262100,2,2,'ID: 6  \nPath: /Product  \nProduct Product',''),(7,'/_default_upload_bucket/raibowcake_3.jpeg','asset','image','image',1,1617262179,1617262179,2,2,'ID: 7  \nPath: /_default_upload_bucket/raibowcake_3.jpeg  \nraibowcake_3.jpeg FileName raibowcake_3.jpeg FileDateTime 1617262179 FileSize 15362 FileType MimeType image/jpeg SectionsFound default upload bucket raibowcake jpeg',''),(7,'/Product/Rainbow Cake','object','object','Product',1,1617262137,1617271189,2,2,'ID: 7  \nPath: /Product/Rainbow Cake  \nRainbow Cake Rainbow Cake Rainbow cookies are common Jewish deli dessert they are pareve. Jewish refugees from Eastern Europe settled New York masse the turn the 20th century they often settled areas that also had Italian population. was this point that Jewish Americans were introduced the rainbow cookie. 1001 Product Cake',''),(8,'/_default_upload_bucket/cookie category.jpeg','asset','image','image',1,1617271499,1617271499,2,2,'ID: 8  \nPath: /_default_upload_bucket/cookie category.jpeg  \ncookie category.jpeg FileName cookie category.jpeg FileDateTime 1617271499 FileSize 13015 FileType MimeType image/jpeg SectionsFound default upload bucket cookie category jpeg',''),(8,'/Category/Cookie','object','object','Category',1,1617271341,1617271530,2,2,'ID: 8  \nPath: /Category/Cookie  \nCookie Cookie cookie baked cooked food that typically small flat and sweet. usually contains flour sugar and some type oil fat. may include other ingredients such raisins oats chocolate chips nuts etc. most English-speaking countries except for the United States crunchy cookies are called biscuits Category Cookie',''),(9,'/_default_upload_bucket/RedVelvet.jpg','asset','image','image',1,1617271779,1617271779,2,2,'ID: 9  \nPath: /_default_upload_bucket/RedVelvet.jpg  \nRedVelvet.jpg FileName RedVelvet.jpg FileDateTime 1617271779 FileSize 47204 FileType MimeType image/jpeg SectionsFound ANY_TAG IFD0 EXIF Orientation XResolution 25400/1000 YResolution 25400/1000 ResolutionUnit Exif_IFD_Pointer ExifVersion 0210 FlashPixVersion 0100 ColorSpace 65535 ExifImageWidth 440 ExifImageLength 400 CodedCharacterSet %G ApplicationRecordVersion default upload bucket RedVelvet jpg',''),(9,'/Product/RedVelvet Cookies','object','object','Product',1,1617271617,1617271964,2,2,'ID: 9  \nPath: /Product/RedVelvet Cookies  \nRedVelvet Cookies Red Velvet Cookies easy make your favorite chocolate chip recipe these cookies pack the fun and flavor red velvet cake into simple and much faster cookie. Super sweet and tender with slightly fudgy center they contain creamy white chocolate chunks that nod the snowy frosting the cake version. 1002 150 Pack Product RedVelvet Cookies','');
...
INSERT INTO `users` VALUES (0,0,'user','system',NULL,NULL,NULL,NULL,NULL,NULL,1,1,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,0,'user','admin','$2y$10$tDc0RLQg0XrQhaB6YZn3Qus8BJSk9g1a.Tm8Nvxt1wAnZ7O5ZGyh6',NULL,NULL,NULL,'en',NULL,1,1,'','',0,1,1,0,'','',NULL,'null',NULL,'','','',1617269323,NULL);
...
/*!50013 DEFINER=`rahu`@`localhost` SQL SECURITY DEFINER */
...
-- Dump completed on 2021-04-01 16:13:32
